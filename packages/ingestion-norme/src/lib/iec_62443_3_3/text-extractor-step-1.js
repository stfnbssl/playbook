...
function main() {
  ...
  if (!config || typeof config !== 'object' || !config.iec_62443_3_3) {
    exitWithError('Configurazione non valida: proprietà radice "iec_62443_3_3" mancante.');
  }
  const params = config.iec_62443_3_3["step"+stepNumber];
  if (!params) {
    exitWithError('Configurazione non valida: proprietà radice "iec_62443_3_3.step"' + stepNumber + ' mancante.');
  }

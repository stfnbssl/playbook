# Cap. 11 — La IEC 62443 come leva di trasformazione (AI/LLM, organizzazione, valore per gli executive)
...
* **Qualità** (completeness, freshness), **versioning** e **provenance**.
...
--- 
## 11.7 Procurement, legale & compliance (LLM‑aware)
**Clausole** 
* Uso dati **solo** per erogazione servizio; **no training** su dati del cliente salvo consenso; **data residency**.
* Diritti su **SBOM/advisory** e log; **DPA** e **audit**; tempi **retention**; cancellazione garantita.
* Requisiti **security** del fornitore (SDL 4‑1, PSIRT, attestazioni).
* **Portabilità**: export knowledge base/metadata per evitare lock‑in.
#### Prompt operativo
“Stendi 8–10 clausole LLM‑aware da inserire nei capitolati OT (privacy, sicurezza, portabilità, audit).”
--- 
## 11.8 Roadmap di capacità (0–6–12–24 mesi)
**0–6 mesi (quick wins)**
* Digitalizza artefatti core (policy, SL‑T, runbook); **catalogo**; **RAG** pilota su policy/accessi remoti.
* **LLM policy** interna; formazione mirata; **guardrail** minimi.
**6–12 mesi**
* Estendi ingest a **PSIRT/SBOM/log**; KPI e **eval set**; integrazione con ticketing.
* Casi d’uso per **Plant Manager** e **SOC** (triage, change/patch co‑pilot).
**12–24 mesi**
* Estensione a più impianti; **governance** completa; audit e **reportistica** automatizzata.
* Valutazione **LLM on‑prem** per contenuti sensibili.
#### Prompt operativo
“Compila la roadmap (0–6/6–12/12–24) con owner, dipendenze e KPI attesi.”
--- 
## 11.9 Rischi & anti‑pattern
* **AI‑first** senza dati/processi: salto nel vuoto.
* **SL4 ovunque**: costi e complessità senza beneficio.
* **Generazione codice non controllata** su sistemi OT.
* **Segreti in prompt** o dataset; **prompt injection** non gestita.
* **Mix IT/OT** indiscriminato; mancanza di **eval**/monitoring.
#### Prompt operativo
“Elenca 6 anti‑pattern e la misura correttiva 62443 corrispondente (FR/controllo).”
--- 
## 11.10 Artefatti & deliverable
* **LLM Policy**; **catalogo data products**; **knowledge base** 62443 indicizzata.
* **Prompt catalog** e **prompt templates**; **eval set** e risultati.
* **Runbook incident AI**; **audit log** invocazioni; **DPIA/AI risk assessment**.
* **Architettura OT LLM Companion**; **matrice guardrail**; **report KPI**.
#### Prompt operativo
“Lista dettagliata degli artefatti con formato, owner, frequenza aggiornamento e fonte.”
--- 
## 11.11 Governance & misurazione (Comitato AI+OT)
**Struttura** 
* Sponsorship **Executive**; membri: OT, IT, Security, Legal, Operations, Quality.
* **Riunioni** mensili; registro decisioni ed **eccezioni**.
**Metriche** 
* **Tempo alla risposta** LLM su procedure; **adozione** per ruolo; **precisione** (eval); % **guardrail** violati bloccati; riduzione tempo **audit**.
#### Prompt operativo
“Definisci charter e KPI del Comitato AI+OT, con cadenza e responsabilità.”
--- 
## 11.12 FAQ per Executive
* **Quanto costa e cosa serve?** → elenco voci CAPEX/OPEX, dipendenze.
